...
public class UserController {
    ...
    public UserController(){
        users.add(new User(1, "John", 21));
        users.add(new User(2, "Kevin", 20));
        users.add(new User(3, "Smith", 20));
    }
    ...
    //GET for http://localhost:8080/users?name=John .Returns all users with the name provided
