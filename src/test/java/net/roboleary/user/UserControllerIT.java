...
public class UserControllerIT {
    ...
    private final User TEST_USER = new User(1, "John", 21);
    private final User TEST_USER_2 = new User(2, "Kevin", 20);
    ...
    public void getUsers_2UsersExist_ReturnOK() throws Exception{
        ...
        String expected = "[{id:1,name:\"John\",age:21},{id:2,name:\"Kevin\",age:20}]";
    ...
    public void getUsersById_Exists_ReturnOK() throws Exception {
        ...
        // verify
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        String expected = "{id:1,name:\"John\",age:21}";
        JSONAssert.assertEquals(expected, response.getBody(),JSONCompareMode.STRICT);
    ...
    public void getUsersByName_Exists_ReturnOK() throws Exception{
        ...
        // execute
        ResponseEntity<String> response = restTemplate.getForEntity(basePath + "?name=John", String.class);
